            ...
            "embeds": [
                {
                    ...
                    "color": _color,
                    "fields": [
                        {"name": "Problem", "value": _problem.problem.title},
                        {"name": "User", "value": _user.username},
                    ]
                    + _fields,
    ...
    def send_on_auth_tried(self, _problem: ProblemAuthLog):
        requests.post(
            ...
            json=self.message(
                ...
                _problem=_problem.problem_instance,
                _user=_problem.user,
                _fields=[{"name": "Trial", "value": _problem.auth_key}],
            ),
        )
    ...
    def send_on_problem_updated(self, _problem: ProblemInstance, _user: User, _point: int):
        requests.post(
            ...
            json=self.message(
                ...
                _user=_user,
                _fields=[
                    {"name": "Points", "value": _point},
                    {"name": "Hidden", "value": ":o:" if _problem.hidden else ":x:"},
                ],
            ),
        )
    ...
    def send_on_question(self, _problem: ProblemInstance, _user: User, _question: str):
        requests.post(
            ...
            json=self.message(
                ...
                _problem=_problem,
                _user=_user,
                _fields=[{"name": "Question", "value": _question}],
            ),
        )
    ...
    def send_on_answer(self, _problem: ProblemInstance, _user: User, _question: str, _answer: str):
        requests.post(
            ...
            json=self.message(
                ...
                _problem=_problem,
                _user=_user,
                _fields=[{"name": "Question", "value": _question}, {"name": "Answer", "value": _answer}],
            ),
        )
